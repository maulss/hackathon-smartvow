...
class _WithdrawDialogState extends ConsumerState<WithdrawDialog> {
  ...
  Future<void> _withdraw() async {
    ...
    try {
      ...
      print('💸 Starting withdrawal: $amountText ETH ($amountWei wei)');

      // Call withdrawPersonal function
      await service.withdrawPersonal(amountWei);

      print('✅ Withdrawal transaction confirmed on blockchain');
      ...
      if (mounted) {
        ...
        _showSuccess('Withdraw berhasil! $amountText ETH');
      }
    } catch (e) {
      ...
      if (mounted) {
        ...
        _showError(
          'Gagal withdraw: ${e.toString().replaceAll('Exception: ', '')}',
        );
      }
    }
  }
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Tarik ETH dari brankas pribadi ke wallet Anda. Saldo tersedia: ${ethBalance.toStringAsFixed(5)} ETH',
                          style: TextStyle(
                            fontSize: 11,
